...
import com.example.dualcameratets.FocusCaptureSessionCallback.Companion.STATE_UNINITIALIZED
import com.example.dualcameratets.MainActivity.Companion.NO_APERTURE
import java.util.*
